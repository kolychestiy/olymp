...
Для начала можно ознакомиться с [функцией Эйелера](http://e-maxx.ru/algo/euler_function).

Поиск обратного по произвольному модулю можно [изучить тут](http://e-maxx.ru/algo/reverse_element).

Из интересных приложений того, что вы изучили в этом разделе можно назвать например криптографический алгоритм шифрования [RSA](https://neerc.ifmo.ru/wiki/index.php?title=RSA).
