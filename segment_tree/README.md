...
void push(int v, int len){
    ...
    // изменяем сумму в детях
    t[v << 1] += (2 * b[v] + d[v] * (len - 1)) >> 1;
    t[v << 1 | 1] += (2 * (b[v] + d[v] * len) + d[v] * (len - 1)) >> 1;
